...
- (void)testCreation
{
    ...
    STAssertEquals(expectedCount, [meeting countOfPersonsPresent], @"count wrong %d", [meeting countOfPersonsPresent]);
    double expectedRate = 0.;
    STAssertEqualsWithAccuracy(expectedRate, [[meeting totalBillingRate] doubleValue], 0.01, @"rate wrong");
}
